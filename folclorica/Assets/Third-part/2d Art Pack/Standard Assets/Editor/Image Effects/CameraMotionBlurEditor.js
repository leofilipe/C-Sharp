...
{	
  ...
  var blurPreviewScale : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    blurPreview = serObj.FindProperty ("blurPreview");
    blurPreviewScale = serObj.FindProperty ("blurPreviewScale");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (blurPreview, new GUIContent("blurPreview"));
    if (blurPreview.boolValue)
      EditorGUILayout.PropertyField (blurPreviewScale, new GUIContent(""));    
